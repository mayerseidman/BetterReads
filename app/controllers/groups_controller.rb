class GroupsController < ApplicationController
  ...
  def index
    ...
    client = Goodreads::Client.new(oauth_token: current_user.oauth_token, api_secret: current_user.oauth_secret)
  ...
  def show
    client = Goodreads::Client.new(oauth_token: current_user.oath_token, api_secret: current_user.oauth_secret)
